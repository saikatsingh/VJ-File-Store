...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002918526071').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://creazystore60:sampa9735@cluster0.4xslp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
CDB_NAME = environ.get("CDB_NAME", "clonetechvj")

# Database Information
DB_URI = environ.get("DB_URI", "mongodb+srv://hamliremle:saikat9735@cluster0.aib0nzz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
